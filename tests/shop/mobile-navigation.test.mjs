...
test("mobile navbar, search and product cards keep the simplified mobile UX", () => {
  ...
  assert.match(navbar, /label: "Catalogo completo"/)
  ...
  assert.match(navbar, /if \(isMobileViewport && step === "register"\)/)
  assert.match(navbar, /detail\?\.step === "register"/)
  assert.match(navbar, /navigate\("\/shop\/account"\)/)
  assert.match(navbar, /registerMobileStep/)
  assert.match(navbar, /Dati personali/)
  assert.match(navbar, /Indirizzo/)
  assert.match(navbar, /Account/)
  assert.match(navbar, /Pagina \{registerMobileStep\} di 3/)
  ...
  assert.match(registerPage, /Indirizzo/)
  assert.match(registerPage, /Account/)
  assert.match(registerPage, /Salva modifiche/)
  assert.match(registerPage, /Password attuale \(solo se cambi email\)/)
})
