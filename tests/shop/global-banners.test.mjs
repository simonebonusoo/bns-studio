...
test("app, navbar and admin expose the new banner management flow", () => {
  ...
  assert.match(app, /GLOBAL_SETTINGS_CACHE_KEY/)
  assert.match(app, /readCachedGlobalSettings/)
  assert.match(app, /globalSettingsLoaded && topBanner\.enabled/)
  assert.match(app, /globalSettingsLoaded && midBanner\.enabled/)
