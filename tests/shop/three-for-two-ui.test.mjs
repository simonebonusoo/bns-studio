...
test("checkout, cart and receipt consume the 3x2 breakdown detail", () => {
  ...
  assert.match(cartPage, /getSafeSubtotalBeforeThreeForTwo/)
  assert.match(cartPage, /Risparmio 3x2/)
  assert.match(cartPage, /Prodotto gratis/)
  assert.match(cartPage, /Calcolata al checkout/)
  assert.match(cartPage, /Totale provvisorio/)
  assert.doesNotMatch(cartPage, /<span>Sconti<\/span>/)
