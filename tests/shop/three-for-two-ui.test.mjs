...
test("checkout, cart and receipt consume the 3x2 breakdown detail", () => {
  ...
  assert.match(navbar, /getSafeSubtotalBeforeThreeForTwo/)
  assert.match(navbar, /getThreeForTwoDiscountAmount/)
  assert.match(navbar, /getThreeForTwoItems/)
  assert.match(navbar, /<span>Risparmio 3x2<\/span>/)
  assert.match(navbar, /Prodotto gratis/)
  assert.match(navbar, /Calcolata al checkout/)
  assert.match(navbar, /Totale provvisorio/)
})
