...
test("static pages expose wider editorial layouts and admin inline editing", () => {
  ...
  assert.doesNotMatch(editor, /bg-\[#e3f503\]/)
  assert.doesNotMatch(editor, /Chiusura pagina/)
  ...
  assert.match(about, /founderTitle/)
  assert.match(about, /founderSectionLabel/)
  assert.match(about, /founderProfileLabel/)
  assert.match(about, /founderDescriptionPrimary/)
  assert.match(about, /founderDescriptionSecondary/)
  ...
  assert.match(about, /founderMember/)
  assert.match(about, /ensureFounderMember/)
  ...
  assert.doesNotMatch(about, /Il nostro staff/)
...
test("static page fallbacks cover real about and privacy content", () => {
  ...
  assert.match(content, /founderSectionLabel/)
  assert.match(content, /founderTitle/)
  assert.match(content, /founderIntro/)
  assert.match(content, /founderProfileLabel/)
  assert.match(content, /founderDescriptionPrimary/)
  assert.match(content, /founderDescriptionSecondary/)
  assert.match(content, /Dietro BNS Studio c'e una persona sola/)
  assert.match(content, /Founder profile/)
