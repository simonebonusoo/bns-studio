...
export function normalizeProductFormStateForEdit(product) {
  ...
  return {
    ...
    personalizationTextEnabled: Boolean(safeProduct.personalizationTextEnabled),
    personalizationTextRequired: Boolean(safeProduct.personalizationTextRequired),
    personalizationTextLabel: String(safeProduct.personalizationTextLabel || ""),
    personalizationTextMaxChars: Number(safeProduct.personalizationTextMaxChars || 50),
    personalizationImageEnabled: Boolean(safeProduct.personalizationImageEnabled),
    personalizationImageRequired: Boolean(safeProduct.personalizationImageRequired),
    personalizationImageLabel: String(safeProduct.personalizationImageLabel || ""),
    personalizationImageInstructions: String(safeProduct.personalizationImageInstructions || ""),
