...
export function ProductGallery({
  ...
  return (
    <div className="grid h-full min-w-0 gap-3 md:grid-cols-[minmax(0,1fr)_84px] md:items-stretch">
      ...
      >
        <div className="flex h-full min-h-[360px] items-center justify-center bg-white/[0.02] p-3 md:min-h-[470px] md:p-3.5">
          {activeImage ? (
      ...
      <div className="grid grid-cols-4 gap-2.5 md:grid-cols-1 md:content-start">
