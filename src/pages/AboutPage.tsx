    ...
    <main className="pb-20 pt-24 md:pb-28 md:pt-28">
      <Container>
        ...
        <article className="glass overflow-hidden rounded-2xl shadow-card">
          <div className="grid gap-8 border-b border-white/10 p-7 md:p-8 xl:grid-cols-[minmax(0,1.14fr)_260px]">
            <div>
            ...
            <div className="overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.03] p-3 xl:ml-auto xl:w-full xl:max-w-[260px]">
